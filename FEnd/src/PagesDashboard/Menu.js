...
export default class Menu extends React.Component {
    ...
    render() {
        return (
            <div class="flex flex-row min-h-screen bg-grey-100 text-grey-800">
                <Sidebar />
                                        ...
                                        <div class="CardEvent" key={index}>
                                            <div class="max-w-sm rounded overflow-hidden shadow-lg border-2 border-gray-200 bg-gray-100">
                                                ...
                                                <div class="px-6 py-4">
                                                    ...
                                                    <div class="font-bold text-xl mb-2 text-red-600"> {item.harga}</div>
                                                    ...
                                                    <div class="font-bold text-xl mb-2 text-black-600"> {item.jenis}</div>
                                                </div>
                                            </div>
                                        </div>
