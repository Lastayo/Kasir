                          ...
                          this.state.transaksi.map((item, index) => {
                            return (
                              <tr key={index}>
                                ...
                                <td>
                                      <button onClick={() =>this.detailStruk(item.id_transaksi)}>Struk</button>
                                </td>
                                x
                              </tr>
                            );
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
              ...
              <div class="px-6 py-6 lg:px-8">
                ...
                <div>
                  ...
                  <div>
                      <label for="id_menu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Harga : {this.state.detailTransaksi.harga}</label>
